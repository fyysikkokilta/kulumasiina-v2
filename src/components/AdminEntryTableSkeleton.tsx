...
function SkeletonCell({ width }: { width: string }) {
  return (
    <td className="border-b border-gray-100 px-3 py-2">
      <div
        className={`h-4 rounded bg-gray-200 ${width} animate-pulse`}
        aria-hidden
      />
    </td>
  )
...
function SkeletonHeaderCell({ width }: { width: string }) {
  return (
    ...
    >
      <div
        className={`h-3 rounded bg-gray-200 ${width} animate-pulse`}
        aria-hidden
      />
    </th>
  )
  ...
  return (
    <div className="space-y-4">
      <div className="flex min-h-12 items-center justify-between gap-4">
        <div
          className="h-9 w-48 animate-pulse rounded bg-gray-200"
          aria-hidden
        />
