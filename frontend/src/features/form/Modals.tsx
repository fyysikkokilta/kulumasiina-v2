  ...
  >
    ...
    >
      ...
      <Form.Item
        ...
        label="Route"
        rules={[
          {required: true, message: "Please provide the used route!"}
        ]}
      >
        <Input.TextArea
          showCount
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item name="value" label="Amount" rules={[
            {required: true, message: "Please provide expense value!"},
            {pattern: /^\d+([.,]\d{1,2})?$/, message: "Please provide a valid positive number!"},
            ]}
        >
